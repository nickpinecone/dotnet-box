...
function Login() {
  ...
  return (
    <div class="container enter-container flex">
          <form class="container-login flex">
            ...
            <ul class=" list-reset list-inputs">
              <li class="inputs-item flex">
                ...
                <input value={login} onChange={(e)=>{setLogin(e.target.value); setError(false)}} class={`inputs-item-input ${error ? 'inputs-item-input_error' : ''} `} type="text" />
              </li>
              ...
              <li class="inputs-item flex">
                ...
                <input value={password} onChange={(e)=>{setPassowrd(e.target.value); setError(false)}} class={`inputs-item-input ${error ? 'inputs-item-input_error' : ''} `} type="text" />
              </li>
            </ul>
          ...
          <Link class="login-recover-password" to="./restore_password">
            Забыл пароль?
          </Link>

          <div class="container-icon-enter flex">
          ...
          <p class="not-account">Нет аккаунта? <Link class="registration_link" to="../registration">Зарегистрироваться</Link></p>
        </div>
  );
}
