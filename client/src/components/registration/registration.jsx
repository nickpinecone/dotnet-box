          ...
          <form class="container-login flex">
            ...
            <ul class=" list-reset list-inputs">
              <li class="inputs-item flex">
                ...
                <input value={name} onChange={(e)=>{setName(e.target.value)}} class="inputs-item-input" type="text" />
              </li>
              ...
              <li class="inputs-item flex">
                ...
                <input value={login} onChange={(e)=>{setLogin(e.target.value)}} class="inputs-item-input" type="text" />
              </li>
              ...
              <li class="inputs-item flex">
                ...
                <input value={password} onChange={(e)=>{setPassowrd(e.target.value)}} class="inputs-item-input" type="text" />
              </li>
            </ul>
